...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕faza Muhammad ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕fazal611 ▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mS
.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mSha

fazal Muhammad \033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : fazal Muhammad 
...
def login():
	...
	try:
		...
		print
		id=raw_input(S + '[☆] ' + S + 'Email: ' + f+'')
		pwd=getpass.getpass(S + '[♡] ' + f + 'Password : ')
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update fazal_muhammad Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' fazal Muhammad WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/fazal_muhammd)
	    os.system('cd $HOME && git clone https://github.com/fazal/Muhammad)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To fazal Muhammad)
	    psb('Congratulations fazal Muhammad Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ fazal611✓')
	    psb('🔓Password ☆ fazal.123✓')
	    psb('Subscrib My Youtube Channel fazal Muhammad ✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/fazal_muhammad&& python2 fazal.py')
	elif bm =='3':
		...
		trb()
		t()https://github.com/users/fazal611/emails/155957352/confirm_verification/8b41d2de7b506d0494c298e742a4296b419473a7?utm_campaign=github-email-verification&utm_content=html&utm_medium=email&utm_source=verification-email
		exb()
	elif bm =='0':
	    exb()
	else:
